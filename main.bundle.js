...
var map = {
	...
	"./basic-color/basic-color.module": [
	...
	"./c3-js/c3-js.module": [
		"../../../../../src/app/theme/chart/c3-js/c3-js.module.ts",
		"c3-js.module"
	],
	...
	"./chart-widget/chart-widget.module": [
		"../../../../../src/app/theme/widget/chart-widget/chart-widget.module.ts",
		"common",
		"chart-widget.module"
	],
	"./data-widget/data-widget.module": [
	...
	"./form-select/form-select.module": [
	...
	"./notification/notification.module": [
		"../../../../../src/app/theme/ui-elements/advance/notification/notification.module.ts",
		"notification.module"
	],
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__layout_auth_auth_component__ = __webpack_require__("../../../../../src/app/layout/auth/auth.component.ts");
...
var routes = [
    {
        ...
        children: [
            ...
            {
                path: 'support',
                loadChildren: './theme/support/support.module#SupportModule'
            },
            {
                path: 'contract',
                loadChildren: './theme/contract/contract.module#ContractModule'
            },
            {
                path: 'navigation',
...
// module
exports.push([module.i, ".small-ok {\n  width: 120px; }\n\n.selector-toggle {\n  display: none; }\n\n.text-danger {\n  display: none; }\n\n.pcoded-header {\n  background: #283891  !important; }\n\n.nn-logo {\n  width: 40px;\n  margin-left: 60px; }\n\n.nn-scrollbar {\n  background: #283891  !important; }\n", ""]);
...
var AdminComponent = (function () {
    function AdminComponent(menuItems, Router, _userService) {
    ...
    AdminComponent.prototype.updatePassword = function () {
        var _this = this;
        __WEBPACK_IMPORTED_MODULE_5_jquery__('.text-danger').hide();
        __WEBPACK_IMPORTED_MODULE_5_jquery__('#error').hide();
        if (this.OldPassword === undefined || this.OldPassword == null || this.OldPassword == "" || this.OldPassword.trim() == "") {
            __WEBPACK_IMPORTED_MODULE_5_jquery__('#old-password-error').show();
            return;
        }
        if (this.NewPassword === undefined || this.NewPassword == null || this.NewPassword == "" || this.NewPassword.trim() == "") {
            __WEBPACK_IMPORTED_MODULE_5_jquery__('#new-password-error').show();
            return;
        }
        if (this.ConfirmPassword === undefined || this.ConfirmPassword == null || this.ConfirmPassword == "" || this.ConfirmPassword.trim() == "") {
            __WEBPACK_IMPORTED_MODULE_5_jquery__('#confirm-password-error').show();
            return;
        }
        if (this.ConfirmPassword != this.NewPassword) {
            __WEBPACK_IMPORTED_MODULE_5_jquery__('#confirm-password-password-error').show();
            return;
        }
        this._userService.changePassword(this.userObject.token, this.NewPassword, this.OldPassword, this.userObject.user._id).subscribe(function (response) {
            __WEBPACK_IMPORTED_MODULE_5_jquery__('#close-btn').click();
            ...
            console.log(err);
            __WEBPACK_IMPORTED_MODULE_5_jquery__('#error').show();
            var obj = JSON.parse(err._body);
            _this.error_message = obj.message;
        });
    };
    ...
    AdminComponent = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_2__shared_menu_items_menu_items__["a" /* MenuItems */], __WEBPACK_IMPORTED_MODULE_3__angular_router__["Router"], __WEBPACK_IMPORTED_MODULE_4__services_user_service__["a" /* UserService */]])
    ], AdminComponent);
...
var TitleComponent = (function () {
    function TitleComponent(router, route, titleService) {
        ...
        this.router.events
            ...
            if (title !== undefined) {
                _this.titleService.setTitle('IFC | Admin Panel');
            }
        });
    }
    TitleComponent = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_2__angular_router__["Router"], __WEBPACK_IMPORTED_MODULE_2__angular_router__["ActivatedRoute"], __WEBPACK_IMPORTED_MODULE_1__angular_platform_browser__["Title"]])
    ], TitleComponent);
...
var AccordionDirective = (function () {
    ...
    AccordionDirective.prototype.ngOnInit = function () {
        var _this = this;
        this._router = this.router.events.filter(function (event) { return event instanceof __WEBPACK_IMPORTED_MODULE_1__angular_router__["NavigationEnd"]; }).subscribe(function (event) {
            _this.countState = 0;
...
// module
exports.push([module.i, ".card .card-header .card-header-right .card-option {\n  width: 190px;\n  transition: unset; }\n\n.card .card-header + .card-block-hid .card-block, .card .card-header + .card-block-hid .card-block-big, .card .card-header + .card-block-hid .card-block-small {\n  padding-top: 0; }\n", ""]);
...
var SpinnerComponent = (function () {
    function SpinnerComponent(router, document) {
        ...
        this.router.events.subscribe(function (event) {
            ...
            else if (event instanceof __WEBPACK_IMPORTED_MODULE_2__angular_router__["NavigationEnd"] || event instanceof __WEBPACK_IMPORTED_MODULE_2__angular_router__["NavigationCancel"] || event instanceof __WEBPACK_IMPORTED_MODULE_2__angular_router__["NavigationError"]) {
    ...
    SpinnerComponent = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_2__angular_router__["Router"], Document])
    ], SpinnerComponent);
...
var ServiceUrl = (function () {
    function ServiceUrl() {
        this.baseUrl = 'https://ico.smartstartuptoken.tech/api/';
        //public baseUrl: string = "http://192.168.100.24:3000/api/";
    }
    return ServiceUrl;
}());
...
var UserService = (function () {
    ...
    UserService.prototype.getUsersList = function (token, numberOfItems) {
        var data;
        data = { pageSize: numberOfItems };
        var headers = new __WEBPACK_IMPORTED_MODULE_2__angular_http__["a" /* Headers */]();
        headers.append('Content-Type', 'application/json; charset=UTF-8');
        headers.append("authorization", "JWT " + token);
        return this.http.post(this.serviceUrl.baseUrl + "admin/getListOfUsers", data, { headers: headers })
            .map(function (res) { return res.json(); });
    };
    UserService.prototype.changePassword = function (token, new_password, old_password, user_id) {
        var data;
        data = { new_password: new_password, old_password: old_password, user_id: user_id };
        var headers = new __WEBPACK_IMPORTED_MODULE_2__angular_http__["a" /* Headers */]();
        headers.append('Content-Type', 'application/json; charset=UTF-8');
        headers.append("authorization", "JWT " + token);
        return this.http.post(this.serviceUrl.baseUrl + "user/changePassword", data, { headers: headers })
            .map(function (res) { return res.json(); });
    };
